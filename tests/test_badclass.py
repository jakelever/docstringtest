...
def test_module_bad():
	with pytest.raises(docstringtest.DocstringTestError) as excinfo:
		docstringtest.testModule(docstringtest.examples.badclass)
...
def test_class_bad():
	with pytest.raises(docstringtest.DocstringTestError) as excinfo:
		docstringtest.testClass(docstringtest.examples.badclass.BadClass)
	assert excinfo.value.message == "Missing docstring"
	assert excinfo.value.funcName == "__init__"
	assert str(excinfo.value) == "Missing docstring for function __init__ in file %s" % exampleclassFilename
	assert os.path.basename(excinfo.value.filename) == 'badclass.py'
...
def test_function_bad___init__():
	with pytest.raises(docstringtest.DocstringTestError) as excinfo:
		docstringtest.testFunction(docstringtest.examples.badclass.BadClass.__init__)
	assert excinfo.value.message == "Missing docstring"
	assert excinfo.value.funcName == "__init__"
	assert str(excinfo.value) == "Missing docstring for function __init__ in file %s" % exampleclassFilename
	assert os.path.basename(excinfo.value.filename) == 'badclass.py'
...
def test_function_bad__shouldBeIgnored():
	...
	docstringtest.testFunction(docstringtest.examples.badclass.BadClass._shouldBeIgnored)

def test_function_bad_staticMethod():
	with pytest.raises(docstringtest.DocstringTestError) as excinfo:
		docstringtest.testFunction(docstringtest.examples.badclass.BadClass.staticMethod)
...
def test_function_bad_staticMethodWithReturn():
	with pytest.raises(docstringtest.DocstringTestError) as excinfo:
		docstringtest.testFunction(docstringtest.examples.badclass.BadClass.staticMethodWithReturn)
...
def test_function_bad_basicMethod():
	with pytest.raises(docstringtest.DocstringTestError) as excinfo:
		docstringtest.testFunction(docstringtest.examples.badclass.BadClass.basicMethod)
...
def test_function_bad_basicMethodWithReturn():
	with pytest.raises(docstringtest.DocstringTestError) as excinfo:
		docstringtest.testFunction(docstringtest.examples.badclass.BadClass.basicMethodWithReturn)
	assert excinfo.value.message == "Missing ':param varA:' in docstring"
...
def test_function_bad_basicMethodWithYield():
	with pytest.raises(docstringtest.DocstringTestError) as excinfo:
		docstringtest.testFunction(docstringtest.examples.badclass.BadClass.basicMethodWithYield)
	assert excinfo.value.message == "Missing ':param varA:' in docstring"
...
def test_function_bad_staticMethodNoVariables():
	with pytest.raises(docstringtest.DocstringTestError) as excinfo:
		docstringtest.testFunction(docstringtest.examples.badclass.BadClass.staticMethodNoVariables)
...
def test_function_bad_staticMethodNoVariablesWithReturn():
	with pytest.raises(docstringtest.DocstringTestError) as excinfo:
		docstringtest.testFunction(docstringtest.examples.badclass.BadClass.staticMethodNoVariablesWithReturn)
...
def test_function_bad_staticMethodNoVariablesWithYield():
	with pytest.raises(docstringtest.DocstringTestError) as excinfo:
		docstringtest.testFunction(docstringtest.examples.badclass.BadClass.staticMethodNoVariablesWithYield)
	assert excinfo.value.message == "Missing docstring"
